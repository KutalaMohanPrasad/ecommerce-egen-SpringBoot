...
delete from ecommerce_product where product_id='120';

delete from ecommerce_order where order_id='030c6947-1816-45c7-abd9-75168cd1c2b3'

delete from ecommerce_address where address_id='9a6f3358-1b90-49a5-b848-3dd6905cd195' or address_id='ce33394b-f7d0-488a-a7b7-18e25ce4e90d'
<!--drop table if exists ecommerce_product,ecommerce_order_item,ecommerce_order,ecommerce_product,ecommerce_address,ecommerce_payment-->
